...
public class BinaryTree {
	...
	public static void main(String[] args) {
		...
		{
			r=rand.nextInt()%N;			
			arrayElements_HIGH[i] =r+2*Math.abs(arrayElements[i]);
		}
	    System.out.println(Arrays.toString(arrayElements));
	    System.out.println(Arrays.toString(arrayElements_HIGH));
